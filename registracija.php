...
<head>
    ...
    <title>Registracija - Newsweek</title>
</head>
<body>
    <header>
        <div id="header_div">
    ...
    <main>
        <div class="forma_div">
            ...
            <?php if ($registriranKorisnik == true): ?>
                <p class="poruka">Korisnik je uspješno registriran! <a href="administrator.php">Prijavi se</a></p>
            <?php else: ?>
                ...
                <form method="POST" action="">
                    ...
                    <?php if ($msg === "Korisničko ime već postoji!"): ?>
                    ...
                    <?php if ($msg === "Lozinke nisu iste!"): ?>
                        <span style="color:red;"><?php echo $msg; ?></span>
                    <?php endif; ?>
                    <input type="password" name="passRep" id="passRep" required>

                    <div>
                        <button class="btn" type="submit" id="slanje">Registriraj se</button>
